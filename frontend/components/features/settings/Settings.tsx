...
export default function Settings({ githubUsername }: SettingsProps) {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 space-y-8">
            ...
            {/* Anti-Charity Mode (Coming Soon) */}
            <div className="bg-[#242424] border border-[#242424]/50 rounded-2xl p-6 opacity-75">
                <div className="flex items-start space-x-4">
                    ...
                    <div className="flex-1">
                        <div className="flex items-center justify-between mb-2">
                            <h3 className="text-xl font-semibold text-[#FBFAEE]">Anti-Charity Mode</h3>
                            <span className="px-2 py-1 bg-[#933DC9]/20 text-[#C488F8] text-xs font-medium rounded-full border border-[#933DC9]/30">Coming Soon</span>
                        </div>
                        <p className="text-sm text-[#FBFAEE]/60 mb-4">
                            High stakes accountability. If you miss your daily commitment, we'll automatically donate money to a cause you <strong>dislike</strong>.
                        </p>

                        <div className="flex items-center space-x-3 p-4 bg-[#000000]/30 rounded-xl border border-[#242424]/60">
                            ...
                            <span className="text-sm font-medium text-[#FBFAEE]/50">Enable Hardcore Mode</span>
                        </div>
                    </div>
                </div>
            </div>
